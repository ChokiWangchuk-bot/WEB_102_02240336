...
exports.getPost = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json({ success: true, data: enhancedPost });
});
...
exports.updatePost = asyncHandler(async (req, res, next) => {
  ...
  posts[index] = { ...post, ...req.body, id: post.id, user_id: post.user_id };

  res.status(200).json({ success: true, data: posts[index] });
});
